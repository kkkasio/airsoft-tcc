    ...
    <form method="POST" class="card card-md" action="{{ route('register') }}">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input id="email" type="email" type="text" name="email"
            ...
            <div class="mb-3">
                ...
                <div class="input-group input-group-flat">
                    <input id="password" type="password" name="password"
                        class="form-control @error('password') is-invalid @enderror" placeholder="Sua senha secreta" required
            ...
            <div class="mb-3">
                ...
                <div class="input-group input-group-flat">
                    <input id="password-confirm" type="password" class="form-control" placeholder="Confirmação da senha secreta" name="password_confirmation"
                    ...
                    <label class="form-selectgroup-item flex-fill">
                        ...
                        <div class="form-selectgroup-label d-flex align-items-center p-3">
                            ...
                            <div>
                                ...
                                Sou administrador de uma  rs<strong>liga</strong>
                            </div>
                        </div>
                    </label>
                </div>
