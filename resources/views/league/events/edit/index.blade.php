                        ...
                        <div class="form-group">
                            <div class="mb-3">
                                ...
                                <input type="file" id="avatar" name="avatar"
                                    ...
                                    <small class="form-hint">Preencha esse campo apenas se quiser <strong>ATUALIZAR</strong> o avatar do evento.</small>
                                @error('avatar')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            <div class="mb-3">
                                ...
                                <input type="file" id="file" name="file"
                                    ...
                                    <small class="form-hint">Preencha esse campo apenas se quiser <strong>ATUALIZAR</strong> o PDF da  missão.</small>
