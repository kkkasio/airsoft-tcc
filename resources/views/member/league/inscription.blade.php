...
<div class="content">
    <div class="container-xl">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <span class="d-sm-inline-block">
                            <a href="{{ route('membro-league-show-event',['id' => $inscricao->event->id]) }}"
        ...
        <div class="row row-cards">
            <div class="col-md-12">
                <form
                    action="{{ route('membro-event-inscricao-weapon-post', ['id' => $inscricao->event->id, 'inscricao' => $inscricao->id]) }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-footer">
                            <button type="submit" class="btn btn-primary ms-auto">Adicionar Arma</button>
                        </div>
                    </div>
                </form>
            </div>
                        ...
                        <table class="table table-vcenter card-table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('membro-event-inscricao-weapon-remove')}}" method="POST">
                                            @csrf
                                            <input type="hidden" name="weapon" value="{{$weapon->id}}" />
                                            <button type="submit" class="btn btn-danger"><svg style="margin: 0" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
